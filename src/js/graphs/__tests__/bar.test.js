...
var _sdplot = require('../../core/_sdplot');
...
describe('<BarPlot />', function () {
  describe('rendering', function () {
    it('Renders properly', function () {
      ...
      var plot = (0, _enzyme.render)(_react2.default.createElement(_bar2.default, {
        id: 'test-id',
    ...
    it('Has the right data after render', function () {
      ...
      var plot = (0, _enzyme.shallow)(_react2.default.createElement(_bar2.default, {
        id: 'test-id',
        className: 'main-graph',
        data: data,
        yNames: ['x', 'y']
      }));
      var chartJSON = plot.find(_sdplot2.default).shallow().instance().chartData;
  ...
  describe('layout', function () {
    ...
    var plotInstance = plot.find(_sdplot2.default).shallow().instance();
